...
export type InputQueryVariables = Exact<{
  customerTag: Scalars['String'];
  collections?: InputMaybe<Array<Scalars['ID']> | Scalars['ID']>;
}>;


export type InputQuery = { __typename?: 'Input', cart: { __typename?: 'Cart', buyerIdentity?: { __typename?: 'BuyerIdentity', customer?: { __typename?: 'Customer', id: string, hasAnyTag: boolean } | null } | null, lines: Array<{ __typename?: 'CartLine', merchandise: { __typename: 'CustomProduct' } | { __typename: 'ProductVariant', id: string, product: { __typename?: 'Product', isGiftCard: boolean, inAnyCollection: boolean } } }> }, discountNode: { __typename?: 'DiscountNode', metafield?: { __typename?: 'Metafield', value: string } | null } };
